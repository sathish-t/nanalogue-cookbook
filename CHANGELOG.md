...
* adds "Spotting variants in sequence data" tutorial for visualizing SNPs alongside modifications
* adds "Simulating test data" section with dedicated pages for simulation configs
* moves simulation configs from tutorials to new `src/simulations/` section
* adds pre-commit hook (`scripts/strip_autogenerated.py`) to strip auto-generated output before commits
* adds test data configs for random errors and heterozygous-like variants
